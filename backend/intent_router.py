...
ROAD_TOPIC_PATTERNS = {
    "en": {
        ...
        "vehicle_color": [r"\bcolo(u)?r\b", r"\bpaint\b"],
        "unlicensed_driver": [r"\bunlicensed\b", r"\blicen[sc]e\b"],
        "speed": [r"\bspeed\b", r"\bspeeding\b"],
        "road_signs": [r"\bsign\b", r"\bsignal\b"],
    ...
    "ar": {
        ...
        "accident": [r"حادث", r"حوادث", r"أضرار", r"اضرار", r"إصابة", r"اصابة", r"نجم"],
        "vehicle_color": [r"لون", r"طلاء", r"صبغ"],
        "unlicensed_driver": [r"رخص", r"مرخص"],
        "speed": [r"سرع"],
        "road_signs": [r"إشار", r"اشار", r"علام", r"لوح"],
        "lane": [r"مسار", r"تجاوز"],
...
def looks_like_followup(question: str) -> bool:
    ...
    if language == "ar":
        return len(text) <= 80 or _matches(
            [r"ماذا عن", r"وماذا", r"طيب", r"هل", r"وهل", r"عن", r"لو", r"ولو"], text
        )
